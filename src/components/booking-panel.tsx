...
const BookingPanel = ({ listing }: { listing: Listing | null }) => {
  ...
  return (
    <div id="booking-panel" className="relative w-full">
      <section className="max-h-[calc(100vh-5rem)] overflow-y-auto sticky top-20 w-full flex flex-col gap-4 bg-white shadow-md p-4 border border-gray-200 rounded-lg z-20">
        ...
        <Link
          href={`/homes/${listing?.listing_id}/book?startDate=${
            startDate || ""
          }&endDate=${endDate || ""}&guests=${guests}`}
